  ...
  return (
    <div className="text-white" style={{ backgroundColor: "transparent" }}>
          ...
          >
            ...
            {stats.map((stat) => (
              <Bento key={stat.label}>
                ...
                >
                  <AnimatedNumber end={stat.end} duration={2000} locale={locale} />
                </div>
                <div
                  style={{
                    fontSize: "1.2rem",
      ...
      <section className="landing-showcase-section">
        <div className="landing-showcase-shell">
          <div className="landing-section-head">
            <h2 className="landing-section-title">{copy(landingCopy.talksTitle)}</h2>
            <p className="landing-section-copy">{copy(landingCopy.talksCopy)}</p>
          </div>
            ...
            {talkHighlights.map((talk) => (
              ...
              >
                ...
                <div className="landing-video-content">
                  ...
                  <p className="landing-video-subtitle">{copy(talk.subtitle)}</p>
      ...
      <section className="landing-showcase-section">
        <div className="landing-showcase-shell">
          <div className="landing-section-head">
            <h2 className="landing-section-title">{copy(landingCopy.eventsTitle)}</h2>
          </div>
