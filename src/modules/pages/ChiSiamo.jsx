  ...
  return (
    ...
    >
      ...
      >
          ...
          <div className="row align-items-center w-100">
            ...
            <div className="col-md-7">
              ...
              >
                ...
                <strong style={{ fontFamily: "GothamBold" }}>
                  {" "}
                  {t("mission.sapienzau")}{" "}
                </strong>
              ...
              <div
                style={{
                  display: "flex",
                  justifyContent: windowSize > 768 ? "flex-start" : "center",
                  marginTop: "24px",
                }}
              >
        ...
        <div
          style={{ width: windowSize > 768 ? "80%" : "100%", margin: "0 auto" }}
        >
          <CustomCarousel />
        </div>
      </div>
        ...
        {carouselImages.map((_, i) => (
          <div
            ...
            style={{
              ...
              borderRadius: "50%",
              backgroundColor:
                i === index ? "#eb0028" : "rgba(255, 255, 255, 0.5)",
              cursor: "pointer",
