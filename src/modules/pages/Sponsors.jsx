...
import { sponsorMarqueeItems, sponsorSections } from "../../data/sponsorsData";
      ...
      >
        {slot.src ? (
          ...
          <span
            ...
            style={{ fontFamily: "ObjectSansHeavy", fontSize: "1.5rem" }}
          >
            {name}
          </span>
        )}
      ...
      <div className="sponsors-shell">
        ...
        <section className="sponsors-hero">
          ...
          <aside className="sponsors-cta-card">
            ...
            <div className="sponsors-cta-contact">
              ...
              <a href={`mailto:${t("sponsors.contactValue")}`}>
        ...
        <section className="max-w-6xl mx-auto mb-20 w-full">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            >
              ...
              >
                {t("sponsors.account_social_raggiunti_number")}
              </strong>
              <span
              ...
              >
                {t("sponsors.account_social_raggiunti_text")}
              </span>
            </Bento>
            <Bento
              style={{
            ...
            >
              ...
              >
                {t("sponsors.sponsor_partners_number")}
              </strong>
              <span
                className="font-bold leading-tight text-white block"
                style={{
              ...
              >
                {t("sponsors.sponsor_partners_text")}
              </span>
            </Bento>
            <Bento
              style={{
        ...
        <section className="max-w-6xl mx-auto mb-20 w-full">
          <div className="flex justify-between items-center mb-12 border-b border-white/20 pb-6">
            ...
            >
              <option value="2026" className="bg-[#101010] text-white">
                2026
              </option>
              <option value="2025" className="bg-[#101010] text-white">
                2025
              </option>
              <option value="2024" className="bg-[#101010] text-white">
                2024
              </option>
              <option value="2023" className="bg-[#101010] text-white">
                2023
              </option>
              <option value="2022" className="bg-[#101010] text-white">
                2022
              </option>
            </select>
          </div>
              ...
              return (
                <article key={section.id} className="w-full flex flex-col">
                  <header className="mb-6">
                    <h3
                      className="text-[#ff92a3] text-sm font-bold uppercase"
                      style={{
