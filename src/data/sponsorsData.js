...
const sponsorLogoLibrary = {
  Autocentri: createSponsorLogo(
    "Autocentri-Balduina",
    "Autocentri Balduina",
    "https://www.autocentribalduina.com",
  ),
  Aesperta: createSponsorLogo(
    "Aesperta",
    "Aesperta Group",
  ...
  Bonduelle: createSponsorLogo(
    "Bonduelle",
    "Bonduelle",
    "https://www.bonduelle.it",
  ),
  CBCR: createSponsorLogo(
    "CBCR",
  ...
  CDP: createSponsorLogo(
    ...
    "https://www.cittametropolitanaroma.it/homepage/la-citta-metropolitana/struttura-organizzativa/altri-organismi/la-consigliera-di-parita/",
  ),
  Copernico: createSponsorLogo(
    "Copernico",
    "Copernico",
    "https://www.copernicofm.com/",
  ),
  CrikCrok: createSponsorLogo("CrikCrok", "Crik Crok", "#"),
  Deloitte: createSponsorLogo(
    "Deloitte",
    "Deloitte",
    "https://www.deloitte.com/it/",
  ),
  Dias: createSponsorLogo(
    "Dias",
    "Libreria Dias",
    "https://www.libreriadias.com/",
  ),
  DirezioneLavoro: createSponsorLogo(
    "Direzione-Lavoro",
    "Direzione Lavoro",
    "https://www.direzionelavoro.it/",
  ),
  Dotcampus: createSponsorLogo(
    "Dotcampus",
    "Dotcampus",
  ...
  HyperFoundry: createSponsorLogo(
    "Hyper-Foundry",
    "Hyper Foundry",
    "https://www.hyper-foundry.com/",
  ),
  HXO: createSponsorLogo(
    "HXO",
    "Humanities InventriX Opera",
    "https://www.hxo.it/",
  ),
  Innocent: createSponsorLogo(
    "Innocent",
    "Innocent Drinks",
  ...
  Kortpress: createSponsorLogo(
    "Kortpress",
    "Kortpress",
    "https://www.kortpress.io/",
  ),
  Marziali: createSponsorLogo(
    "Marziali",
    "Marziali",
    "https://www.marzialicaffe.it/",
  ),
  MentorsNova: createSponsorLogo(
    "MentorsNova",
    "Mentors Nova",
    "https://mentors4u.com/",
  ),
  MIC: createSponsorLogo(
    "MIC",
    "Musei in Comune Card",
    "https://www.museiincomuneroma.it/it/infopage/mic-card/",
  ),
  Millionaire: createSponsorLogo(
    "Millionaire",
    "Millionaire",
    "https://millionaire.it/",
  ),
  MyDiet: createSponsorLogo("MyDiet", "MyDiet", "https://mydietroma.it/", {
    tileLogoScale: 1.22,
    slotLogoScale: 1.68,
  }),
  MSG: createSponsorLogo(
    "MSG",
    "Ministro per lo Sport e i Giovani",
    "https://sportegiovani.governo.it/",
  ),
  NAM: createSponsorLogo("NAM", "NAM Studio", "https://namstudio.it/"),
  NovoNordisk: createSponsorLogo(
    "Novo-Nordisk",
    "Novo Nordisk",
    "https://www.novonordisk.it/",
    {
      tileLogoScale: 1.3,
    },
  ),
  ...
  Pioda: createSponsorLogo(
    "Pioda",
    "Pioda Imaging",
    "https://www.piodaimaging.it/",
  ),
  PE: createSponsorLogo(
    "PE",
    "Parlamento Europeo",
    "https://www.europarl.europa.eu/",
  ),
  RadioKaos: createSponsorLogo(
    "RadioKaos",
    "Radio Kaos",
    "https://www.radiokaositaly.com/",
  ),
  RadioSapienza: createSponsorLogo(
    "RadioSapienza",
    "Radio Sapienza",
  ...
  RegioneLazio: createSponsorLogo(
    "RegioneLazio",
    "Regione Lazio",
  ...
  SapienzaGladiators: createSponsorLogo(
    "SapienzaGladiators",
    "Sapienza Gladiators",
    "https://www.sapienzagladiators.it/",
  ),
  SFClubSapienza: createSponsorLogo(
    "SFClubSapienza",
    "SF Club Sapienza",
    "https://www.instagram.com/sfclubsapienza/",
  ),
  Technotown: createSponsorLogo(
    "Technotown",
    "TechnoTown",
    "https:/www.technotown.it/",
  ),
  TFI: createSponsorLogo(
    "TFI",
    "Teach For Italy",
  ...
  Viscosa: createSponsorLogo(
    "Viscosa",
    "Collettivo Viscosa",
    "https://www.instagram.com/collettivoviscosa/",
  ),
  WAYouth: createSponsorLogo("WAYouth", "WA Youth", "https://www.wayouth.it/"),
  YPT: createSponsorLogo(
    "YPT",
    "Your Personal Trainer",
    "https://www.yptrainer.com/",
  ),
...
export const sponsorSections = [
  ...
  },
  {
    ...
    slots: [createYearSlot(2026, "Kortpress")].filter((slot) =>
      Boolean(slot.src),
    ),
  },
  {
